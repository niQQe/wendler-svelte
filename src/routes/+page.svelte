					...
					<div class="flex gap-3">
						...
						>
							...
							<div class="flex justify-end gap-3 text-sm">
								<button class="rounded border py-2.5 px-6" on:click={() => (showNewExerciseForm = false)}>Cancel</button>
								<button class="bg-[#18181b] py-2.5 px-6 rounded text-white font-medium text-sm" type="submit">Add</button>
							</div>
						</form>
					</div>
				</div>
